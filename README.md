...
Best practices for using MariaDB's built-in vector support for AI and semantic search applications. Covers RAG patterns, vector indexes, distance functions, embedding model selection, and framework integrations (LangChain, LlamaIndex, Spring AI).

> MariaDB has native vector support since version 11.7 — no extensions or plugins needed.
