...
- [Replication Overview — MariaDB KB](https://mariadb.com/kb/en/replication-overview/)
- [GTID — MariaDB KB](https://mariadb.com/kb/en/gtid/)
- [Parallel Replication — MariaDB KB](https://mariadb.com/kb/en/parallel-replication/)
- [Semi-Synchronous Replication — MariaDB KB](https://mariadb.com/kb/en/semisynchronous-replication/)
